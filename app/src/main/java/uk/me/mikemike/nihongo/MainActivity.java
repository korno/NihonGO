...
import uk.me.mikemike.nihongo.activities.DebugDeckListActivity;
import uk.me.mikemike.nihongo.model.Deck;
import uk.me.mikemike.nihongo.viewmodels.NihongoViewModel;

public class MainActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener, Observer<RealmResults<Deck>> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*
        XmlImporter importer = new XmlImporter(r,getResources().getXml(R.xml.testxml),
                "", "", 0);
        importer.importData();
